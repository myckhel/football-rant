        ...
        <article class="product">
          <header class="product-header">
            ...
            <div class="product-buttons">
              ...
              <a class="product-button fa fa-eye" data-placement="right" title="View {{$team->name}}" href="{{route('club', [implode('-', explode(' ', 'atletico'))])}}" style="font-size: 26px"></a>
                <a id="join_btn{{$team->id}}" class="product-button fa fa-plus" data-placement="right" title="Join {{$team->name}}" href="#" style="font-size: 25px"
                onclick="event.preventDefault(); joinTeam('{{$team->id}}');"></a>
          ...
          <footer class="product-content">
            <h6 class="product-title"><a href="#">{{$team->name}} FC</a></h6>
