...
<footer class="section footer-classic footer-classic-dark context-dark">
  <div class="footer-classic-main">
    <div class="container">
      ...
      <!-- RD Mailform-->
      <form class="rd-mailform rd-form rd-inline-form-creative" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="bat/rd-mailform.php" novalidate="novalidate">
        <div class="form-wrap">
          <div class="form-input-wrap">
            <input class="form-input form-control-has-validation" id="footer-form-email" type="email" name="email" data-constraints="@Required"><span class="form-validation"></span>
            <label class="form-label rd-input-label" for="footer-form-email">Enter your E-mail</label>
          </div>
        </div>
      ...
      <div class="row row-50">
        <div class="col-lg-5 text-center text-sm-left">
          <article class="unit unit-sm-horizontal unit-middle justify-content-center justify-content-sm-start footer-classic-info">
            <div class="unit-left"><a class="brand brand-md link-circle" href=""><img class="brand-logo " src="{{URL::asset('images/team/logo/'.$GLOBALS['current']->badge)}}" alt="" width="129" height="129"></a>
            </div>
            <div class="unit-body">
            ...
            <div class="col-sm-6">
                    ...
                    <article class="post-classic">
                      ...
                      <div class="post-classic-main">
                        ...
                        <p class="post-classic-title"><a href="blog-post.html">A Quick Look at Premier League Winners </a></p>
