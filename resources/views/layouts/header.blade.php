...
<meta name="chromesniffer" id="chromesniffer_meta" content="{&quot;Google Analytics&quot;:-1,&quot;jQuery&quot;:&quot;3.2.1&quot;,&quot;SPDY&quot;:-1,&quot;Bootstrap&quot;:-1}">
<script type="text/javascript" async="" src="{{URL::asset('js/ec.js')}}">
</script>
<script type="text/javascript" async="" src="{{URL::asset('js/analytics.js')}}">
</script>
...
<!-- Page-->
<div class="page animated" style="animation-duration: 300ms;">
  <!-- Page Header-->
          ...
          <div class="rd-navbar-panel-inner container">
              ...
              <div class="owl-carousel-navbar owl-carousel-inline-outer">
                ...
                <div class="owl-carousel-inline-wrap">
                  ...
                  <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1412px, 0px, 0px); transition: all 0.25s ease 0s; width: 2473px;"><div class="owl-item cloned" style="width: 343.188px; margin-right: 10px;"><article class="post-inline">
                      ...
                      <time class="post-inline-time" datetime="2018">April 15, 2018</time>
                      <p class="post-inline-title">Atletico vs Real Madrid</p>
                    </article></div><div class="owl-item" style="width: 343.188px; margin-right: 10px;"><article class="post-inline">
                      <time class="post-inline-time" datetime="2018">April 15, 2018</time>
                      <p class="post-inline-title">Atletico vs Celta Vigo</p>
                    </article></div><div class="owl-item" style="width: 343.188px; margin-right: 10px;"><article class="post-inline">
                      <time class="post-inline-time" datetime="2018">April 15, 2018</time>
                      <p class="post-inline-title">Atletico vs Dream Team</p>
                    </article></div><div class="owl-item active" style="width: 343.188px; margin-right: 10px;"><article class="post-inline">
                      <time class="post-inline-time" datetime="2018">April 15, 2018</time>
                      <p class="post-inline-title">Atletico vs Real Madrid</p>
                    </article></div><div class="owl-item cloned" style="width: 343.188px; margin-right: 10px;"><article class="post-inline">
                      <time class="post-inline-time" datetime="2018">April 15, 2018</time>
            ...
            <div class="rd-navbar-panel-item rd-navbar-panel-item-right">
              <ul class="list-inline list-inline-bordered">
                <li>
                  <!-- Select 2-->
                  <div class="select2-container select select-inline" id="s2id_autogen1">
                    <a href="javascript:void(0)" class="select2-choice" tabindex="-1">
                      <span class="select2-chosen" id="select2-chosen-2">en</span><abbr class="select2-search-choice-close"></abbr>
                    ...
                    <div class="select2-drop select2-display-none select-inline-dropdown">
                  ...
                  <select class="select select-inline" data-placeholder="Select an option" data-dropdown-class="select-inline-dropdown" tabindex="-1" title="" style="display: none;">
                ...
                <li>
                  <div class="cart-inline-toggled-outer">
                    <!-- Link Cart-->
                    <button class="link link-cart cart-inline-toggle toggle-original" data-rd-navbar-toggle="#cart-inline"><span class="link-cart-icon fl-bigmug-line-shopping202"></span><span class="link-cart-counter">2</span></button>
                    <!-- Cart Inline-->
                        ...
                        <div class="cart-inline-main">
                                ...
                                <article class="product-inline">
                                  ...
                                  <div class="product-inline-main">
                                    ...
                                    <ul class="product-inline-meta">
                                      <li>
                                        <div class="stepper "><input class="form-input stepper-input" type="number" data-zeros="true" value="1" min="1" max="100"><span class="stepper-arrow up"></span><span class="stepper-arrow down"></span></div>
                                      </li>
                                      <li>
                                        <p class="product-inline-price">$500.00</p>
                                      </li>
            ...
            <div class="rd-navbar-main-container container">
              ...
              <div class="rd-navbar-search toggle-original-elements">
                ...
                <form class="rd-search" action="search-results.html" data-search-live="rd-search-results-live" method="GET">
                  <div class="form-wrap">
                    <label class="form-label rd-input-label" for="rd-navbar-search-form-input">Enter your search request here...</label>
          ...
          <div class="rd-navbar-main-bottom rd-navbar-darker">
            <div class="rd-navbar-main-container container">
              ...
              <ul class="rd-navbar-nav">
                ...
                <li class="rd-nav-item rd-navbar--has-dropdown rd-navbar-submenu"><a class="rd-nav-link" href="news.html">News</a><span class="rd-navbar-submenu-toggle"></span>
                  <!-- RD Navbar Dropdown-->
                  <ul class="rd-menu rd-navbar-dropdown">
                    <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="blog-post.html">Blog post</a></li>
                  </ul>
                </li>
                <li class="rd-nav-item rd-navbar--has-dropdown rd-navbar-submenu"><a class="rd-nav-link" href="shop.html">Shop</a><span class="rd-navbar-submenu-toggle"></span>
                  <!-- RD Navbar Dropdown-->
                  <ul class="rd-menu rd-navbar-dropdown">
                ...
                <li class="rd-nav-item"><a class="rd-nav-link" href="contact-us.html">Groups</a>
                </li>
